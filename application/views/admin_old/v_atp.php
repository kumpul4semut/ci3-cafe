		...
		<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                       ...
                       <a type="button" data-toggle="modal" data-target="#modal-tambah" class="button text-white bg-theme-1 shadow-md mr-2">Atur Penjualan</a>
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center border-b">
                                    <?php echo date('M Y', strtotime($data->waktu_tpenjualan));  ?>
                                </td>
                                 <td class="text-center border-b">
                                   Rp. <?php echo number_format($data->target_penjualan,'0','.','.') ?>
                                </td>
                                <td class="border-b w-5">
                                    <div class="flex sm:justify-center items-center">
                                    	  <a type="button" data-toggle="modal" data-target="#modal-edit<?=$data->id_tpenjualan;?>" class="flex items-center mr-3" style="cursor: pointer;"><i data-feather="check-square" class="w-4 h-4 mr-1"></i> Ubah</a>
                                       	   
                                        <a class="flex items-center text-theme-6" href="<?php echo site_url('admin/target_penjualan/hapus_target/'.$data->id_tpenjualan); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$data->id_tpenjualan;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Hapus </a>
			...
			<div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<input type="date" name="waktu_tpenjualan" class="input w-full border mt-2 flex-1" >
				</div>

				<div class="col-span-12 sm:col-span-6">
				<label align="left">Target :</label>
				<input type="number" name="target_penjualan" class="input w-full border mt-2 flex-1" placeholder="Masukkan Target">
				</div>
			...
			<div class="modal fade" id="modal-edit<?=$data->id_tpenjualan;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-span-12 sm:col-span-6">
				<label align="left">Waktu :</label>
				<input type="date" name="waktu_tpenjualan" value="<?= $data->waktu_tpenjualan ?>" class="input w-full border mt-2 flex-1" >
				</div>

				<div class="col-span-12 sm:col-span-6">
				<label align="left">Target :</label>
				<input type="number" name="target_penjualan" value="<?= $data->target_penjualan ?>" class="input w-full border mt-2 flex-1" placeholder="Masukkan Target">
				</div>
