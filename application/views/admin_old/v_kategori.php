...
<a type="button" data-toggle="modal" data-target="#modal-tambah" style="text-decoration:none;cursor: pointer;">Tambah kategori</a></div>
...
<th data-field="id" data-sortable="true">Nama Kategori</th>
<th>Aksi</th>
</tr>
</thead>
<tbody>
...
<a type="button" data-toggle="modal" data-target="#modal-edit<?=$row->id_kategori;?>" class="ubah btn btn-primary btn-xs" style="cursor: pointer;"><i class="glyphicon glyphicon-edit"></i></a>
<a class="hapus btn btn-danger btn-xs" href="<?php echo site_url('admin/kategori/hapus/'.$row->id_kategori); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$row->nama_kategori;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i></a>
</td>
