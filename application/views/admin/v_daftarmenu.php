		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading"><svg class="glyph stroked male user ">
					...
					<a type="button" data-toggle="modal" data-target="#modal-tambah" style="text-decoration:none;cursor: pointer;">Tambah Daftar Menu</a>
				</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name="id_kategori" oninvalid="this.setCustomValidity('Form Ini Harus Di isi')" onchange="this.setCustomValidity('')" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="nama_menu" class="form-control" oninvalid="this.setCustomValidity('Form Ini Harus Di isi')" onchange="this.setCustomValidity('')" required>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" name="stok" class="form-control" oninvalid="this.setCustomValidity('Form Ini Harus Di isi')" onchange="this.setCustomValidity('')" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label align="left">Harga :</label>
									<input type="number" name="harga" class="form-control" oninvalid="this.setCustomValidity('Form Ini Harus Di isi')" onchange="this.setCustomValidity('')" required>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="form-control" name="status" oninvalid="this.setCustomValidity('Form Ini Harus Di isi')" onchange="this.setCustomValidity('')" required>
