					...
					<tbody>
					<?php $no = 0; foreach($jabatan as $row) : $no++;?>
					<tr>
					...
					<a data-toggle="modal"  title="Hapus Jabatan" class="hapus btn btn-danger btn-xs" href="#modKonfirmasi" data-id="<?php echo $row->id_jabatan;?>"><span class="glyphicon glyphicon-trash"></span></a>
					</td>
